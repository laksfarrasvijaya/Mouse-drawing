...
pygame.display.set_caption("Mouse Position Tracker with Drawing and Undo")
...
def redraw_drawing_surface(surface, lines):
    surface.fill(WHITE)
        ...
        for event in pygame.event.get():
            if event.type == pygame.QUIT:
                ...
                if event.key == pygame.K_s:
                    ...
                    if lines:
                        lines.pop()
                        redraw_drawing_surface(drawing_surface, lines)
